        ...
        <div className="space-y-4">
          ...
          <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl bg-clip-text text-transparent bg-gradient-to-b from-white to-white/70 animate-fade-in-up">
            ...
            <div className="block mt-2">
              <span className="text-blue-600">Aspiring Fullstack </span>
          ...
          {/* Description */}
          <p className="mt-6 text-gray-400 text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed animate-fade-in-up delay-200">
          ...
          <div className="flex flex-col sm:flex-row gap-6 mt-16 justify-center animate-fade-in-up delay-300">
            <Link href="#projects">
              <Button size="lg" className="relative group px-8">
                <span className="absolute -inset-0.5 bg-gradient-to-r from-red-400 via-red-600 to-red-300 rounded-lg blur opacity-50 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-gradient-xy"></span>
